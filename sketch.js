...
function setup() {
  ...
  //rectMode(CENTER);
    ...
    rope2 = new rope(bob2.body,roof1.body,+60);
    rope3 = new rope(bob3.body,roof1.body,-60);
    rope4 = new rope(bob4.body,roof1.body,-120);
    rope5 = new rope(bob5.body,roof1.body,120);
  //	Engine.run(engine);
